...
function trustedHeaders(
  ...
  h.set("cookie", clientGatewaySessionCookieHeader());
...
async function proxy(req: NextRequest, method: "GET" | "POST") {
  try {
    ...
    const clientId = String(
      incoming.searchParams.get("clientId") ||
    ...
    const target = new URL("/api/patient-sponsor-links/eligibility", requiredApiBase());
