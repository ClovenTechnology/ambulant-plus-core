      ...
      <main className="mx-auto max-w-7xl px-4 py-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1.6fr_1.1fr] gap-4">
          ...
          <section className="rounded-xl border bg-white shadow-sm">
            ...
            <div className="p-4 space-y-4">
              {panel === 'GLUCOSE' ? (
                <GlucosePanel glucose={glucose} setGlucose={setGlucose} disabled={busy || !contextReady} />
              ) : panel === 'THYROID' ? (
                <ThyroidPanel thyroid={thyroid} setThyroid={setThyroid} disabled={busy || !contextReady} />
              ) : panel === 'FOOT' ? (
                <FootPanel foot={foot} setFoot={setFoot} disabled={busy || !contextReady} />
              ) : (
                <WeightPanel weight={weight} setWeight={setWeight} disabled={busy || !contextReady} />
              )}
