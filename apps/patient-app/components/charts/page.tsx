...
import LiveVitalsChart from "../../components/charts/LiveVitalsChart";
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">
            Streaming from IoMT {live ? <span className="ml-2 inline-flex items-center text-emerald-600">● live</span> : <span className="ml-2 text-rose-600">● offline</span>}
          </p>
        </div>
      </motion.div>
