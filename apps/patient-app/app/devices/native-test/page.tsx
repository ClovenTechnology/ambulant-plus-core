          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <a
                  href="/devices/native-test/nexring"
                  className="inline-flex min-h-[44px] items-center rounded-2xl bg-cyan-300 px-4 py-2 text-sm font-semibold text-slate-950"
                >
                  Open NexRing native console
                </a>
                <a
                  href="/devices/native-test/nexring/web"
                  className="inline-flex min-h-[44px] items-center rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-white"
                >
                  Open NexRing web diagnostic
                </a>
              </div>
            </div>
