// apps/patient-app/app/devices/native-test/nexring/web/page.tsx
'use client';
...
export default function NexRingConsole() {
  ...
  return (
    <main data-p-ui="patient-nexring-web-diagnostic-page" className="min-w-0 overflow-x-clip mx-auto max-w-5xl space-y-4 p-6">
      <header className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">NexRing Web Bluetooth diagnostic</h1>
          <p className="mt-1 text-sm text-slate-500">
            Engineering-only Web Bluetooth transport console. This preserves the proven browser GATT path while the patient-facing NexRing page uses the shared production session.
          </p>
        </div>
