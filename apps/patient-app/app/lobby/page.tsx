...
export default function Lobby() {
  ...
  return (
    <main className="p-6 max-w-xl mx-auto space-y-6">
      <h1 className="text-2xl font-semibold">Patient Lobby</h1>

      <div className="rounded border p-4 space-y-3 bg-white">
        <label className="block text-sm text-gray-600">This is your waiting area to prepare yourself for your upcoming appointment. You can take time to exhale, test your devices or take your vitals. Your clinician will see Vitals taken here as your latest Vitals, you can also still take more readings during your session</label>
        <input
          value={roomId}
          onChange={(e) => setRoomId(e.target.value)}
          className="border rounded px-3 py-2 w-full"
          placeholder="e.g. MyAppointment, call-123"
        />
        <div className="flex flex-wrap gap-2">
          <a href={links.patient} target="_blank" rel="noreferrer" className="px-3 py-2 border rounded hover:bg-gray-100">
            Proceed to my Consultation (new tab)
          </a>
        </div>
      </div>
      ...
      <div className="rounded border p-4 space-y-3 bg-white">
        ...
        <div className="text-sm text-gray-600">Share the invite link with intended participants e.g Your carer or dependants. Note: Do not share link with unauthorized parties/entities or anyone who shouldn't be part of this session.</div>
        ...
        <div className="pt-2">
          <button
            onClick={() => copy(`Patient: ${links.patient}`)}
