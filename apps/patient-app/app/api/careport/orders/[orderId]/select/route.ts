// FILE: apps/patient-app/app/api/careport/orders/[orderId]/select/route.ts
...
export async function POST(req: NextRequest, { params }: { params: { orderId: string } }) {
  ...
  const upstream = new URL(`/api/careport/orders/${encodeURIComponent(orderId)}/select`, base);
