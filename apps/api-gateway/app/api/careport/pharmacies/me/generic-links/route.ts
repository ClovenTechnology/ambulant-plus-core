...
export const GET = withPartnerBoundary(partnerOriginalGET, '/api/careport/pharmacies/me/generic-links');
export const POST = withPartnerBoundary(partnerOriginalPOST, '/api/careport/pharmacies/me/generic-links');
