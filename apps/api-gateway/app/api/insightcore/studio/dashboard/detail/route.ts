// apps/api-gateway/app/api/insightcore/studio/dashboard/detail/route.ts
import { NextRequest, NextResponse } from 'next/server';
import { prisma } from '@/src/lib/db';
import { OperatorDashboardAssembler } from '@/../../packages/insightcore/src/studio/OperatorDashboardAssembler';
...
export async function GET(req: NextRequest) {
  ...
  const assembler = new OperatorDashboardAssembler();
