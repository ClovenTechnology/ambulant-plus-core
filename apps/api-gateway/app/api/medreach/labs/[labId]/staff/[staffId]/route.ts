...
export const PATCH = withPartnerBoundary(partnerOriginalPATCH, '/api/medreach/labs/[labId]/staff/[staffId]');
export const DELETE = withPartnerBoundary(partnerOriginalDELETE, '/api/medreach/labs/[labId]/staff/[staffId]');
