...
export const GET = withPartnerBoundary(partnerOriginalGET, '/api/medreach/labs/[labId]/offers');
export const POST = withPartnerBoundary(partnerOriginalPOST, '/api/medreach/labs/[labId]/offers');
