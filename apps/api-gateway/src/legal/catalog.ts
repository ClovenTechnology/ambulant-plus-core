export const LEGAL_DOCUMENT_KEYS = {
  ...
  PLATFORM_PRIVACY_NOTICE: 'PLATFORM_PRIVACY_NOTICE',
  PLATFORM_CLINICAL_DISCLAIMER: 'PLATFORM_CLINICAL_DISCLAIMER',
  PLATFORM_COMPLIANCE_STATEMENT: 'PLATFORM_COMPLIANCE_STATEMENT',
...
export const LEGAL_DOCUMENT_CATALOG: readonly LegalCatalogEntry[] = [
  ...
  {
    key: LEGAL_DOCUMENT_KEYS.PLATFORM_TERMS_OF_SERVICE,
    title: 'Platform Terms of Service',
    category: 'terms',
    audiences: ['public'],
    applications: ['landing'],
    surfaces: ['public-legal'],
    acknowledgementMode: 'NOTICE',
  },
  {
    key: LEGAL_DOCUMENT_KEYS.PLATFORM_PRIVACY_NOTICE,
  ...
  {
    key: LEGAL_DOCUMENT_KEYS.PLATFORM_CLINICAL_DISCLAIMER,
  ...
  {
    key: LEGAL_DOCUMENT_KEYS.PLATFORM_COMPLIANCE_STATEMENT,
