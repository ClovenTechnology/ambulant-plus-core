...
function forwardHeaders(req: NextRequest, contentType = 'application/json') {
...
export async function GET(req: NextRequest) {
  ...
  const upstream = await fetch(`${base}/api/admin/clinicians/governance${req.nextUrl.search || ''}`, {
    method: 'GET',
    cache: 'no-store',
...
export async function PATCH(req: NextRequest) {
  ...
  const upstream = await fetch(`${base}/api/admin/clinicians/governance`, {
    method: 'PATCH',
    cache: 'no-store',
