...
export async function GET(req: NextRequest) {
  ...
  const url = base + '/api/careport/pharmacies/me/inventory' + req.nextUrl.search;
...
export async function POST(req: NextRequest) {
  ...
  const res = await fetch(base + '/api/careport/pharmacies/me/inventory' + req.nextUrl.search, {
    method: 'POST',
    headers,
    body,
    cache: 'no-store',
