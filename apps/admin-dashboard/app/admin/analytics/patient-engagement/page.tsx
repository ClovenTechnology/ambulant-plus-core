// apps/admin-dashboard/app/admin/analytics/patient-engagement/page.tsx
'use client';
...
export default function PatientEngagementAnalyticsPage() {
    ...
    void (async () => {
      ...
      try {
        ...
        const res = await fetch(
          `/api/admin/analytics/patient-engagement?${params.toString()}`,
          {
            cache: 'no-store',
          },
        );
  ...
  /* ------------ Derived insights (front-end only) ------------ */
  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 p-6">
      ...
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col items-end gap-2 text-xs">
          <div className="inline-flex overflow-hidden rounded-full border bg-white">
            ...
            <Link
              href="/admin/analytics/patient-engagement"
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => {
                // re-trigger fetch with same range
                setRange((prev) => prev);
              }}
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          <div className="rounded-2xl border bg-white p-4 shadow-sm text-xs">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="text-[11px] text-gray-400">
                Heatmap placeholder – wire to chart component
              </span>
            </div>

            <div className="mb-3 h-40 rounded-xl border border-dashed bg-gray-50/60 text-center text-[11px] text-gray-400 flex items-center justify-center">
          ...
          <div className="rounded-2xl border bg-white p-4 shadow-sm text-xs">
            ...
            <div className="mb-3 h-32 rounded-xl border border-dashed bg-gray-50/60 text-center text-[11px] text-gray-400 flex items-center justify-center">
        ...
        <div className="rounded-2xl border bg-white p-4 shadow-sm text-xs">
          <div className="mb-2 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-[11px] text-gray-500">
                Which connected devices patients rely on most – NexRing,
                Health Monitor, Digital Stethoscope, etc.
              </p>
            </div>
            <span className="text-[11px] text-gray-400">
      ...
      {/* DEMOGRAPHICS & LIFESTYLE (STEPS / CALORIES) */}
