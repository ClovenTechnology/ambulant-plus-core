...
export function humanizeOpportunityError(error: unknown) {
  ...
  const known: Record<string, string> = {
    ...
    invalid_opportunity_image: 'Images must use HTTPS and include alt text. Remove both fields to publish without an image.',
    invalid_opportunity_tags: 'Tags must be unique, canonical and limited to 12.',
