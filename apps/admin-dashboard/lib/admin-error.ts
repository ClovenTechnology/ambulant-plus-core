...
const MESSAGES: Record<string, string> = {
  ...
  password_minimum_12_characters: 'Use at least 12 characters for your new password.',
  password_maximum_128_characters: 'Use no more than 128 characters for your new password.',
  password_must_not_contain_spaces: 'Do not use spaces in your new password.',
  password_requires_lowercase: 'Include at least one lowercase letter in your new password.',
  password_requires_uppercase: 'Include at least one uppercase letter in your new password.',
  password_requires_number: 'Include at least one number in your new password.',
  password_requires_symbol: 'Include at least one symbol in your new password.',
