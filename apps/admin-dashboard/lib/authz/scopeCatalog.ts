...
export const SCOPE_GROUPS: ScopeGroup[] = [
  {
    ...
    items: [
      ...
      { scope: 'recruitment.templates.read', label: 'Read recruitment templates', desc: 'View reusable recruitment templates and defaults.' },
      { scope: 'recruitment.templates.manage', label: 'Manage recruitment templates', desc: 'Create, edit, activate and archive recruitment templates.', danger: true },
      { scope: 'recruitment.settings.manage', label: 'Manage recruitment settings', desc: 'Change global recruitment and Staff onboarding defaults.', danger: true },
...
export const SCOPE_ALIASES: Record<string, string> = {
  ...
  'recruitment.templates': 'recruitment.templates.read',
  'recruitment.manage': 'recruitment.templates.manage',
  'recruitment.settings': 'recruitment.settings.manage',
  'applications.onboarding': 'applications.onboarding.manage',
