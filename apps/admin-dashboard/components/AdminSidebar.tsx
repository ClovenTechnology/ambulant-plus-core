...
{ href: '/admin/medreach/reviews', label: 'Review moderation', icon: Syringe, requires: 'medical' },
      ...
      },
      {
        ...
        icon: Store,
        defaultOpen: true,
        requires: ['hr', 'manageRoles', 'compliance', 'medical', 'forms.read', 'forms.design', 'forms.publish', 'opportunities.read', 'opportunities.manage', 'opportunities.publish', 'applications.read', 'applications.review', 'applications.assign', 'applications.decision'],
        items: [
          ...
          { href: '/admin/applications', label: 'Applications', icon: ClipboardCheck, requires: ['applications.read', 'applications.review', 'applications.assign', 'applications.decision'] },
