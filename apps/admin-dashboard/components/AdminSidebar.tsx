...
{ href: '/admin/medreach/reviews', label: 'Review moderation', icon: Syringe, requires: 'medical' },
      ...
      },
      {
        ...
        icon: Store,
        defaultOpen: true,
        requires: ['hr', 'manageRoles', 'compliance', 'medical', 'forms.read', 'forms.design', 'forms.publish', 'opportunities.read', 'opportunities.manage', 'opportunities.publish', 'applications.read', 'applications.review', 'applications.assign', 'applications.decision', 'applications.documents.read', 'applications.documents.request', 'applications.documents.review', 'applications.interviews.read', 'applications.interviews.schedule', 'applications.interviews.manage'],
        items: [
          ...
          { href: '/admin/meetings', label: 'Meetings', icon: CalendarDays, requires: ['meetings.create', 'meetings.moderate', 'meetings.audit.read', 'applications.interviews.read', 'applications.interviews.schedule', 'applications.interviews.manage'] },
          ...
          { href: '/admin/applications', label: 'Applications', icon: ClipboardCheck, requires: ['applications.read', 'applications.review', 'applications.assign', 'applications.decision', 'applications.documents.read', 'applications.documents.request', 'applications.documents.review', 'applications.interviews.read', 'applications.interviews.schedule', 'applications.interviews.manage'] },
