...
const ROLES = ["lab", "phleb"];
const publicPaths = new Set(['/', '/auth/login', '/login', '/auth/activate', '/auth/signup', '/auth/signup/evidence', '/favicon.ico', '/robots.txt']);
const publicApis = new Set(['/api/partner-auth/login', '/api/partner-auth/activate', '/api/partner-auth/logout', '/api/partner-auth/me', '/api/onboarding/labs', '/api/onboarding/lab', '/api/onboarding/phleb', '/api/onboarding/evidence', '/api/careport/partners/pharmacy/apply', '/api/careport/partners/rider/apply']);
