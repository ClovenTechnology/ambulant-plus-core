...
export default function Login() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!["lab", "phleb"].includes(a.role)) { await fetch('/api/partner-auth/logout', { method: 'POST' }); throw new Error('Use the partner app for your role.'); }
