...
const companyLinks = [
  ...
  { label: "Prepare for Appointment", href: "/resources/prepare-for-your-appointment" },
  { label: "After Consultation", href: "/resources/after-your-consultation" },
  { label: "Personal Health Management", href: "/resources/personal-health-management" },
  { label: "CarePort Patient Guide", href: "/resources/careport-patient-guide" },
  { label: "MedReach Patient Guide", href: "/resources/medreach-patient-guide" },
