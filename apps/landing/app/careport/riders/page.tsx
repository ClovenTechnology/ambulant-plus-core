...
export const metadata = { title: "CarePort for riders", description: "CarePort gives riders a structured medicine-delivery workflow for identity verification, handover, route progression, patient updates, proof" };
const bullets = ['Complete rider onboarding, identity verification and operational readiness checks.',
'Follow medicine handover rules and keep medication packages secure.',
  ...
  return (
    <main>
      <section className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:px-6 md:py-20 lg:grid-cols-[1fr_0.95fr] lg:items-center">
        <div>
          <div className="text-xs font-bold uppercase tracking-[0.28em] text-cyan-700">CarePort riders</div>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950 md:text-6xl">CarePort for riders</h1>
          <p className="mt-6 text-lg leading-9 text-slate-600">CarePort gives riders a structured medicine-delivery workflow for identity verification, handover, route progression, patient updates, proof-of-delivery, safety and payout visibility.</p>
