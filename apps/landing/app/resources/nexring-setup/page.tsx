...
export const metadata: Metadata = {
  title: "NexRing Setup and Wearing Guide | Ambulant+ Resources",
  description: "Set up and wear NexRing correctly for supported wearable health context including heart-rate trends, sleep insights, activity patterns and temperature-variation signals.",
  keywords: [
    "NexRing setup",
    ...
    "continuous wellness context",
    "Contactless Medicine resources"
],
  alternates: {
    canonical: absoluteUrl("/resources/nexring-setup"),
  },
};

const sections = [
  {
    title: "Sizing before setup",
    body: "Correct sizing improves comfort, signal quality and day-to-day adherence.",
    bullets: ["Use the sizing kit to confirm ring size before unboxing the final device where applicable.", "Choose a fit that is secure but comfortable enough for regular wear.", "Select your preferred finish where available, such as silver, black, gold or rose gold.", "Contact support before forcing a size that feels uncomfortable."],
  },
{
    title: "Best wearing position",
    body: "Signal quality and durability depend on how the ring is worn.",
    bullets: ["Wear on the index finger of the less-dominant hand where possible.", "This position may provide stronger pulse signals and reduce wear from frequent contact with surfaces.", "Align the light sensor to the palm-side or inner side of the finger.", "The ring can be worn on another comfortable finger if required, but consistency matters for trend interpretation."],
  },
{
    title: "First pairing",
    body: "Initial pairing should be done slowly and correctly.",
    bullets: ["Charge the ring to 100% before first setup.", "Keep the ring on the charger during initial pairing.", "Turn on Bluetooth and location permissions where the mobile device requires them.", "Open the NexRing app, add a new ring and confirm the device shown during pairing.", "Allow up to 24 hours for fuller data population after setup."],
  },
{
    title: "How to use the data",
    body: "NexRing data is most useful as longitudinal context, not a single isolated number.",
    bullets: ["Use instant readings such as heart-rate checks where available.", "Review sleep, activity and temperature-variation trends over time.", "Use temperature-variation context carefully in fertility or wellness discussions, as supportive information rather than diagnosis.", "Share relevant trends with clinicians during Ambulant+ consultations when clinically appropriate."],
  }
];
...
const jsonLd = {
  ...
  inLanguage: "en-ZA",
  mainEntityOfPage: absoluteUrl("/resources/nexring-setup"),
};
