...
export const seoRoutes: SeoRoute[] = [
  ...
  {
    path: "/resources/prepare-for-your-appointment",
    ...
    keywords: ["prepare for virtual consultation", "Ambulant+ appointment preparation", "triage symptoms guide", "remote consultation preparation", "take vitals before appointment", "Health Monitor appointment", "Contactless Medicine appointment", "online doctor appointment preparation", "Ambulant+ resources", "Contactless Medicine resources", "patient guide South Africa"],
    priority: 0.82,
    changeFrequency: "monthly",
  },
  {
    path: "/resources/after-your-consultation",
    ...
    keywords: ["after virtual consultation", "Ambulant+ treatment plan", "CarePort eRx", "MedReach lab orders", "book follow-up doctor", "medicine delivery after consultation", "remote care follow-up", "Contactless Medicine continuity", "Ambulant+ resources", "Contactless Medicine resources", "patient guide South Africa"],
    priority: 0.82,
    changeFrequency: "monthly",
  },
  {
    path: "/resources/personal-health-management",
    title: "Personal Health Management Suite",
    ...
    keywords: ["personal health management app", "Health Passport", "home vitals monitoring", "self-check health app", "medication reminders", "family care app", "remote patient monitoring trends", "Ambulant+ personal health management", "Ambulant+ resources", "Contactless Medicine resources", "patient guide South Africa"],
    priority: 0.82,
    changeFrequency: "monthly",
  },
  {
    path: "/resources/careport-patient-guide",
    ...
    keywords: ["CarePort patient guide", "eRx fulfilment", "medicine delivery South Africa", "prescription delivery", "pharmacy fulfilment", "proof of delivery medicine", "medication adherence support", "Ambulant+ CarePort", "Ambulant+ resources", "Contactless Medicine resources", "patient guide South Africa"],
    priority: 0.82,
    changeFrequency: "monthly",
  },
  {
    path: "/resources/medreach-patient-guide",
    ...
    keywords: ["MedReach patient guide", "home phlebotomy", "home blood draw", "lab orders", "specimen handling", "laboratory result routing", "home diagnostics South Africa", "Ambulant+ MedReach", "Ambulant+ resources", "Contactless Medicine resources", "patient guide South Africa"],
    priority: 0.82,
    changeFrequency: "monthly",
  },
  {
  ...
  {
    path: "/resources/health-monitor-setup",
    title: "Health Monitor Setup Guide | Ambulant+ Resources",
    description:
      "Set up the Ambulant+ Health Monitor for supported remote vitals workflows including temperature, SpO₂, heart rate, blood pressure, blood glucose and ECG capture.",
    keywords: [
      "Health Monitor setup",
  ...
  {
    path: "/resources/digital-stethoscope-workflow",
    title: "Digital Stethoscope Workflow | Ambulant+ Resources",
    description:
      "Use the Ambulant+ Digital Stethoscope workflow for live remote auscultation, heart and lung listening, audio recording, playback, notes and follow-up comparison.",
    keywords: [
  ...
  {
    path: "/resources/nexring-setup",
    title: "NexRing Setup and Wearing Guide | Ambulant+ Resources",
    description:
      "Set up and wear NexRing correctly for supported wearable health context including heart-rate trends, sleep insights, activity patterns and temperature-variation signals.",
    keywords: [
      "NexRing setup",
      "smart ring health monitor",
      "wearable health ring",
  ...
  {
    path: "/resources/medical-aid-deployment-guide",
    title: "Medical Aid Deployment Guide | Ambulant+ Resources",
    description:
      "A deployment guide for medical aids, HMOs, employers and sponsors using Ambulant+ for preventive care, remote monitoring, adherence, rewards, claims visibility and programme intelligence.",
    keywords: [
  ...
  {
    path: "/resources/hd-otoscope-workflow",
  ...
  {
    path: "/resources/find-a-doctor-and-book-appointment",
