...
export async function GET(req: NextRequest) {
  try {
    ...
    const upstream = new URL('/api/careport/admin/kyc/pharmacies', apigwBase());
    ...
    return NextResponse.json({ ok: false, error: error?.message || 'careport_admin_pharmacies_proxy_failed', pharmacies: [] }, { status: 502 });
  }
}
