...
export async function GET(req: NextRequest) {
  try {
    ...
    const upstream = new URL('/api/careport/admin/orders', apigwBase());
    ...
    return NextResponse.json({ ok: false, error: error?.message || 'careport_admin_orders_proxy_failed', orders: [] }, { status: 502 });
  }
}
